...
urlpatterns = [
    ...
    path('<str:username>/manage/proposal-accepted/<str:pk>', views.accept_proposal, name='accept_proposal'),
    path('<str:username>/manage/proposal-denied/<str:pk>', views.deny_proposal, name='deny_proposal'),
    ...
    path('<str:username>/profile/payment/<str:pk>', views.payment, name='payment'),
    path('<str:username>/profile/payment/confirmed/', views.confirm_pay, name='confirm_pay'),
